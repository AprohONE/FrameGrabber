...
public class VideoService {
    ...
    private final String analyticsServiceUrl = "http://localhost:8082/api/analyze/frame";
    ...
    public void processLiveStream(String streamUrl) {
        ...
        processingThread = new Thread(() -> {
            try (FFmpegFrameGrabber grabber = new FFmpegFrameGrabber(streamUrl)) {
                BufferedWriter writer = new BufferedWriter(new FileWriter("framesLog.txt", true));
